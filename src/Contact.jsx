      ...
      <div className="container contact_div">
        <div className="row">
          ...
          <div class="mb-3">
              ...
              <input type="text" class="form-control" id="exampleFormControlInput1" name='fName' value={data.fName} onChange={fire} placeholder="Enter your name" />
            </div>
            ...
            <div className="col-12">
              <Link to='/Resume'><button className='btn btn-outline-dark' type='submit'>Submit</button></Link> 
            </div>

            <div className='col-12 mt-5'>
            If you have any questions, or want more information about working with me feel free to reach out to me at <span style={{fontWeight:"bold"}}>prachirajtiwari.work@gmail.com</span>
            </div>
            </form>
          </div>
        </div>
